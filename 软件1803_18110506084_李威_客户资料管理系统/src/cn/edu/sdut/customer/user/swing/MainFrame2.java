...
public class MainFrame2 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public MainFrame2(User user) {
		
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainFrame2.class.getResource("/images/customer.png")));
		setTitle("客户资料管理系统");
		...
		label_3.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/mangecom.png")));
		
		JLabel username = new JLabel(user.getUsername());
		username.setFont(new Font("宋体", Font.PLAIN, 16));
		username.setForeground(Color.WHITE);
		
		JLabel userlevel =new JLabel("普通管理员");
		...
		lblNewLabel_1.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/add.png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/list.png")));
		...
		weatherIcon.setIcon(new ImageIcon(MainFrame2.class.getResource(weatherIconUrl)));
		...
		lblNewLabel_13.setBounds(1147, 223, 201, 173);
		contentPane.add(lblNewLabel_13);
		
		JLabel label_2 = new JLabel("关于我们");
		label_2.setIcon(new ImageIcon(MainFrame2.class.getResource("/lombok/installer/eclipse/myeclipse.png")));
		label_2.setForeground(Color.WHITE);
		label_2.setFont(new Font("微软雅黑 Light", Font.PLAIN, 27));
		label_2.setBorder(new MatteBorder(0, 0, 1, 0, (Color) Color.WHITE));
		label_2.setBounds(900, 800, 144, 59);
		...
		lblNewLabel_15.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg2.png")));
		lblNewLabel_15.setBounds(1163, 216, 382, 285);
		contentPane.add(lblNewLabel_15);
		
		JLabel lblNewLabel_12 = new JLabel("");
		lblNewLabel_12.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg.png")));
		lblNewLabel_12.setBounds(0, 956, 1919, 59);
		contentPane.add(lblNewLabel_12);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg.png")));
		
		JLabel label_21 = new JLabel("");
		label_21.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg.png")));
		label_21.setBounds(0, 223, 407, 83);
		contentPane.add(label_21);
		
		JLabel topbackground = new JLabel("");
		topbackground.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/framebg.png")));
		...
		backgroung.setIcon(new ImageIcon(MainFrame2.class.getResource("/images/bg8.jpg")));
